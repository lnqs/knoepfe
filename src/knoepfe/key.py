...
class Renderer:
    ...
    def __init__(self, config: dict[str, Any] | None = None) -> None:
        ...
        self.default_text_font = self.config.get("default_text_font", "Roboto")
        self.default_icon_font = self.config.get("default_icon_font", "Material Icons")
...
class Key:
    def __init__(self, device: StreamDeck, index: int, config: dict[str, Any] | None = None) -> None:
        self.device = device
        self.index = index
        self.config = config or {}
