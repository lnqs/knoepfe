...
@fixture
def streaming_widget(mock_plugin):
    return Streaming(StreamingConfig(), mock_plugin)


def test_streaming_init(mock_plugin):
    widget = Streaming(StreamingConfig(), mock_plugin)
